...
- [x] **The first element**: a black background and white text
- [x] **The second element**: a yellow background
- [x] **Both elements**: a font size of 28px and a list of fonts containing `Helvetica` and `Times New Roman`, with `sans-serif` as a fallback
